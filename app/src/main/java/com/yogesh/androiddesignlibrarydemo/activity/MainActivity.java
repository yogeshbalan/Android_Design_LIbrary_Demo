...
import com.yogesh.androiddesignlibrarydemo.fragment.CheeseListFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setImageDrawable(MainActivity.this.getResources().getDrawable(R.drawable.ic_done_white));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_collapse) {
            startActivity(new Intent(MainActivity.this, ScrollingActivity.class));
        } else if (id == R.id.nav_coordinator) {
            startActivity(new Intent(MainActivity.this, CoordinatorActivity.class));
        } else if (id == R.id.nav_coordinator_custom) {
            startActivity(new Intent(MainActivity.this, CustomBehaviorActivity.class));
        } else if (id == R.id.nav_snack_bar) {
            startActivity(new Intent(MainActivity.this, SnackBarDemoActivity.class));
